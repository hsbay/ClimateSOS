...
def make_appendix_c_attractors() -> List[WeightedCascadeAttractor]:
    ...
    return [
        ...
        A("C15", "AMOC / ocean-circulation disruption", "biosphere", ["Ocean Cycle Bus"], ["Cryosphere Feedback Bus", "Water-Cycle Bus", "Ecosystem Metabolism Bus"], 1.4, 0.35, 1.00, 1.50, 0.95, 0.55, "Ocean circulation disruption changes regional climate, sea-level patterns, and biosphere stability."),
